...
public interface SysUserMapper {
    ...
    SysUser checkSocialUser(@Param("familyName") String familyName, @Param("givenName") String givenName, @Param("email") String email);

    SysUser selectUserByUserNameAndEmail(@Param("username") String username, @Param("email")String email);
}
